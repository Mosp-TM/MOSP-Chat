  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: `Echo from ${model}: ${userMsg.content}`,
        },
      ]);
      setLoading(false);
    }, 1000);
      ...
      {!hasCompletedSetup ? (
        ...
        <>
          ...
          <div className="flex-1 flex flex-col h-full relative">
            {/* Header */}
            <header className="border-b bg-gradient-to-r from-primary to-purple-700 p-4 text-primary-foreground flex items-center gap-3 shadow-sm z-10">
